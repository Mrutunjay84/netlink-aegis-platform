...
function patchNav() {
	...
	if (original.includes("'/policy-builder'") && original.includes("'/audit-evidence'")) {
		console.log('[feature-patch] nav entries already present; skipping');
		return;
	}
	...
	console.log('[feature-patch] added Policy Builder + Audit Evidence nav entries');
}
...
const MESSAGES = {
	...
	policyBuilderDescription:
		'Generate a tailored governance policy with AI from your industry and compliance framework, edit it in a rich editor, then save it to the register or export to Word/PDF.',
	auditEvidence: 'Audit Evidence',
	auditEvidenceDescription:
		'Get AI guidance on what evidence to collect for each audit control and exactly where to capture it, tailored to your technology scope.'
};
